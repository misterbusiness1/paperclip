    ...
    <div className="max-w-6xl space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="overflow-hidden rounded-xl border border-border">
          <div className="grid grid-cols-(--gtc-company-access-mobile) gap-3 border-b border-border px-4 py-3 text-xs font-medium uppercase tracking-wide text-muted-foreground sm:grid-cols-(--gtc-24)">
          ...
          {members.length === 0 ? (
            ...
            members.map((member) => {
              ...
              return (
                <div
                  key={member.id}
                  className="grid grid-cols-(--gtc-company-access-mobile) gap-3 border-b border-border px-4 py-3 last:border-b-0 sm:grid-cols-(--gtc-24)"
                >
