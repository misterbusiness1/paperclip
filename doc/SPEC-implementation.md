...
- V1 attachment serving contract:
  ...
  - Attachment content and deletion routes reject malformed attachment UUIDs with `400` before querying storage metadata; missing or cross-company attachment IDs return `404`.
